...
<span style="font-size:13px;font-family:Open Sans;font-weight:bold;color:#595959;">SEPTEMBER 2021– MARCH 2025</span><br>
<span style="font-size:13px;font-family:Open Sans;color:#595959;">Received Ph.D. Degress in College of Computer Science and Technology</span><br>
</div>
<div id="expand-box-header">
...
+ **Donghua Wang**, Wen Yao, Tingsong Jiang, Xiaohu Zhen and Junqi Wu. "[**Improving the Transferability of Adversarial Examples by Feature Augmentation[J]**](https://doi.org/10.1109/tnnls.2025.3563855)."*IEEE Transactions on Neural Networks and Learning Systems*, *0*(0), 1-15, 2025. [[CODE](https://github.com/winterwindwang/)]
+ **Donghua Wang**, Wen Yao, Tingsong Jiang, Chao Li and Xiaoqian Chen. "[**Universal Multi-view Black-box Attack against Object Detectors via Layout Optimization[C]**](https://doi.org/10.1109/tcsvt.2025.3540881)."*IEEE Transactions on Circuits and Systems for Video Technology*, *0*(0), 1-1, 2025. [[CODE](https://github.com/winterwindwang/)]
